...
with subprocess.Popen(  # noqa: S603 - args are hardcoded literals, no untrusted input
    [GIT_EXECUTABLE, "describe", "--tags"], stdout=subprocess.PIPE, stderr=subprocess.PIPE
) as proc:
